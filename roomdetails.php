				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="Room.html">View More</a></li>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation2.php"><h2>BOOK NOW</h2></a>
</div>

			<div class="clearfix"> </div>
</div>

<img src="images/amenities.png">
...
<!-- /contact -->
			<div class="copy">
		        <p>© Copyright 2021  <a href="index.php">STARHOTEL</a>  <small> Last updated: 1/11/2021 </small> </p>
		    </div>
