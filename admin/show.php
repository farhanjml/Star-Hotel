...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>STARHOTEL BOOKING RECEIPT</h1>
			<addres >
				<p>STARHOTEL</p>
				<p>Jalan 50350,<br>Kuala Lumpur,
				<p>+604 254 4422</p>
			</address>
		...
		<article>
			...
			<address >
				...
				<p><br></p>
				<p>Name  :   <?php echo $title." ".$Fname." ".$lname;?><br></p>
			</address>
			<table class="meta">
				<tr>
			...
			<table >
					<tr> 
						<td>Customer Phone Number :  <?php echo $phone; ?> </td>
		...
		<aside>
			<h1><span ></span></h1>
			<div >
				<p align="center">info@starhotel.com.my | +604 254 4422 </p>
			</div>
		</aside>
	</body>
</html>
